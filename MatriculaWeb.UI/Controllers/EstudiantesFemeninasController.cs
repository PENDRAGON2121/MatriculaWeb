...
{
    public class EstudiantesFemeninasController : Controller
    {
        // GET: EstudiantesFemeninasController
        public async Task<ActionResult> Index()
        {
            ...
            var response = await clientehttp.GetAsync("https://apiserviceexamen.azurewebsites.net/api/GestionDeMatriculas/ObtengaLasFemeninas");
            //Response en JSON
